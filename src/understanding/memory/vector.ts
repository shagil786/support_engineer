 ...
 *  Ported verbatim from src/support-voice-agent/memory/vector.ts, plus a
 *  `purge` capability so EpisodicMemory can drop scoped records (the
 *  legacy class had no removal path).
 *
 ...
 *  behind the same `VectorMemory` port later.
 */
